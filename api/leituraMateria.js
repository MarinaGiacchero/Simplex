...
var tabelaMateria=  function leituraMateria(res, i, finalizar){
    ...
    axios.get(url).then(async function (response) {
        ...
        if(response.data.DetalheMateria.Materia==undefined){
            ...
            if(finalizar == 150){
                ...
                var ciclo = new leituraMateria(res, i, finalizar); 
            }
         ...
         //   console.log(situ.data.SituacaoAtualMateria.Materias.Materia[0].SituacaoAtual.Autuacoes.Autuacao[0].Situacoes.Situacao[0].CodigoSituacao)
            if(situ.data.SituacaoAtualMateria.Materias.Materia[0].SituacaoAtual.Autuacoes.Autuacao[0].Situacoes == undefined){
                idSituacao = 1;
            }else{
