...
module.exports = {
    ...
    configure: function (app) {
        ...
        var Controller = require('../controller/natureza');
       // const passport = require('passport');
        ...
        app.get('/rest/naturezas', function (req, res) {
       //     const index = req.rawHeaders.indexOf('Authorization')
        ...
        app.get('/rest/natureza/:id/', function (req, res) {
            controller.getById(res, req);
        });

        // here we insert an object.
        app.post('/rest/natureza', function (req, res) {

            controller.add(req, res);
        });

        // here we update an object.
        app.put('/rest/natureza',  function (req, res) {
            controller.update(req, res);
        });

        // here we delete an object passing id to it object method.
        app.delete('/rest/natureza/:id', function (req, res) {
