...
function RegionController() {
    ...
    this.isNameInUse = function (name, res) {
        ...
        .then((isNameInUse) => {
            ...
            console.log("Nome da região está em uso? " + (isNameInUse ? "Sim" : "Não"));
        });
    };
    ...
    this.isInitialsInUse = function (initials, res) {
        ...
        .then((isInitialsInUse) => {
            ...
            console.log("Sigla da região está em uso? " + (isInitialsInUse ? "Sim" : "Não"));
        });
    };
    ...
    this.update = function (req, res) {
        ...
        console.log("Nome " + req.body.name + ", sigla " + req.body.initials);
